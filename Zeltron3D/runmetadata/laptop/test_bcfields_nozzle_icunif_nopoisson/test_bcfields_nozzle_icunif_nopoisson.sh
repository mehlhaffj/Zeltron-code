SIM_ROOT=/mnt/c/Users/mehlhafj/OneDrive/Documents/JohnsWork/1_Research/PROJECTS/jet_environment_interact/laptop/3d
SIM=test_bcfields_nozzle_icunif_nopoisson
BASE_DIR=$(dirname ${BASH_SOURCE[0]})
RUN_CMD="bash ./script_run.sh"
...
MOVES_TO=( mod_input.f90 Makefile script_run.sh )
