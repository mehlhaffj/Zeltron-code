...
CHARACTER(LEN=10), PARAMETER, PUBLIC :: BOUND_PART_XMIN="REFLECT"
CHARACTER(LEN=10), PARAMETER, PUBLIC :: BOUND_PART_XMAX="REFLECT"
CHARACTER(LEN=10), PARAMETER, PUBLIC :: BOUND_PART_YMIN="REFLECT"
CHARACTER(LEN=10), PARAMETER, PUBLIC :: BOUND_PART_YMAX="REFLECT"
CHARACTER(LEN=10), PARAMETER, PUBLIC :: BOUND_PART_ZMIN="INJECT"
CHARACTER(LEN=10), PARAMETER, PUBLIC :: BOUND_PART_ZMAX="REFLECT"
...
INTEGER*8, PARAMETER, PUBLIC :: NCX=512

! Number of cells in Y
INTEGER*8, PARAMETER, PUBLIC :: NCY=NCX

! Number of cells in Z
INTEGER*8, PARAMETER, PUBLIC :: NCZ=2*NCX
...
DOUBLE PRECISION, PARAMETER, PUBLIC :: xmin=-1024d0,xmax=1024d0
...
INTEGER, PARAMETER, PUBLIC :: NDUMP=200
...
! background plasma
DOUBLE PRECISION, PARAMETER, PUBLIC :: sigma_bg = 2d0**6
...
DOUBLE PRECISION, PARAMETER, PUBLIC :: thbe=1d0/SQRT(sigma_bg) * 2.0
...
DOUBLE PRECISION, PARAMETER, PUBLIC :: rlc=2*kappa*sigma_inj*rhoc  ! 2*kappa*ratio_nb2nd*sigma_bg*rhoc
! Nozzle radius
...
DOUBLE PRECISION, PARAMETER, PUBLIC :: over_inject=2.0  ! SQRT(sigma_bg)
...
LOGICAL, PARAMETER, PUBLIC :: ANALYZE_FLUID=.TRUE.
...
LOGICAL, PARAMETER, PUBLIC :: ANALYZE_RADIATION=.TRUE.
