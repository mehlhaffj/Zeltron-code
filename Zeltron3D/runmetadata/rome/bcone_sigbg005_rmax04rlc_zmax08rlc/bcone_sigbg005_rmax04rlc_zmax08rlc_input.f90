...
DOUBLE PRECISION, PARAMETER, PUBLIC :: xmin=-128d0,xmax=128d0
...
! background plasma
DOUBLE PRECISION, PARAMETER, PUBLIC :: sigma_bg = 1.5d0**4
...
DOUBLE PRECISION, PARAMETER, PUBLIC :: thbe=1d0/SQRT(sigma_bg) * 1.2
...
DOUBLE PRECISION, PARAMETER, PUBLIC :: over_inject=SQRT(sigma_bg)
