SIM_ROOT=${SCRATCH}/jetenviron/3d
SIM=bcone_sigbg016_rmax04rlc_zmax16rlc
BASE_DIR=$(dirname ${BASH_SOURCE[0]})
RUN_CMD="sbatch ./submit_stampede.sh"
...
MOVES_TO=( mod_input.f90 Makefile submit_stampede.sh )
